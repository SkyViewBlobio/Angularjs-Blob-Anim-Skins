...
document.addEventListener("DOMContentLoaded", function () {
    var canvas = document.getElementById("shaderElevenCanvas"); // Adjust the canvas ID accordingly
    ...
    // Fragment shader source code for ShaderEleven
    var fsSource = `
    #ifdef GL_ES
    ...
    // Discard fragments outside of a circular shape
    if (length(uv) > 1.8) {
        discard;
    }
